...
typedef enum JSIterateOp {
    ...
    JSENUMERATE_INIT_ALL,   /* Create new iterator state over all properties - haleyjd 20150507 */
 ...
 *    object regardless of enumerability. haleyjd: Adapted from JSAPI 1.8.5.
 *
 *  JSENUMERATE_NEXT
